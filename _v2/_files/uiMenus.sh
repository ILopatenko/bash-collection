...
printMainMenu(){
   ...
   echo -e "    ${fr}**${frb}    ${sl7}  7. PRIVATE SETTINGS       ${frb}     ${fr}**${gbg}     "
   echo -e "    ${fr}**${frb}                                     ${fr}**${gbg}     "
   echo -e "    ${fr}*****************************************${gbg}     "
   echo -e "                                                  ${Drop}"
}
...
printPrivateMenu(){
   ...
   echo -e "    ${fr}*****************************************${gbg}     "
   echo -e "    ${fr}**${frb}                                     ${fr}**${gbg}     "
   echo -e "    ${fr}**${frb}        ${mt}7. PRIVATE MENU:             ${fr}**${gbg}     "
   echo -e "    ${fr}**${frb}                                     ${fr}**${gbg}     "
   echo -e "    ${fr}**${frb}    ${sl71}  7.1. CONNECT NFS          ${frb}     ${fr}**${gbg}     "
   echo -e "    ${fr}**${frb}    ${sl72}  7.2. NFS FOR DOCKER       ${frb}     ${fr}**${gbg}     "
   echo -e "    ${fr}**${frb}    ${sl73}  7.3. RESERVED             ${frb}     ${fr}**${gbg}     "
   echo -e "    ${fr}**${frb}    ${sl74}  7.4. RESERVED             ${frb}     ${fr}**${gbg}     "
   echo -e "    ${fr}**${frb}    ${sl75}  7.5. RESERVED             ${frb}     ${fr}**${gbg}     "
   echo -e "    ${fr}**${frb}    ${sl75}  7.6. RESERVED             ${frb}     ${fr}**${gbg}     "
   echo -e "    ${fr}**${frb}    ${sl75}  7.7. RESERVED             ${frb}     ${fr}**${gbg}     "
   echo -e "    ${fr}**${frb}                                     ${fr}**${gbg}     "
   echo -e "    ${fr}*****************************************${gbg}     "
   echo -e "                                                  ${Drop}"
}
